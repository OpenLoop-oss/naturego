        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex items-center gap-3 mt-6">
              ...
              <a
                href="#"
                className="w-10 h-10 rounded-xl bg-gradient-to-br from-purple-600 via-pink-500 to-orange-400 flex items-center justify-center hover:scale-110 transition-transform"
              >
              ...
              <a
                href="#"
                className="w-10 h-10 rounded-xl bg-blue-600 flex items-center justify-center hover:scale-110 transition-transform"
              >
                <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                href="#"
                className="w-10 h-10 rounded-xl bg-black flex items-center justify-center hover:scale-110 transition-transform border border-gray-700"
              >
                <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-16 pt-8 border-t border-white/10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <p className="text-sm text-gray-500">
              © {new Date().getFullYear()} NatureGo. Crafted with care.
            </p>
          </div>
        </div>
      </div>
